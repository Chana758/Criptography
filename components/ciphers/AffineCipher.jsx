  ...
  return (
    <main className="flex-1 bg-slate-50 p-8">
      <div className="max-w-2xl">
        <h1 className="text-4xl font-bold text-slate-900 mb-2 font-serif">Affine Cipher</h1>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              <label className="block text-sm font-semibold text-slate-900 mb-2">
                Parameter a (must be coprime with 26)
              </label>
              <select
                value={a}
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h2 className="text-lg font-bold text-slate-900 mb-4">Examples</h2>
          <div className="space-y-3 text-sm">
            <div>
              <p className="text-slate-600 mb-2">With a=5, b=8:</p>
              <div className="bg-slate-50 p-3 rounded">
                <p className="font-mono"><span className="font-semibold">H</span> → position 7 → (5×7+8) mod 26 = 15 → <span className="font-semibold">P</span></p>
              </div>
            </div>
          </div>
        </div>
